# ref: https://github.com/streamlit/docs/blob/main/python/api-examples-source/data.column_config.py
import random
...
max_age_data = edited_data.loc[edited_data['age'].idxmax()]
st.write('Max age name = ', max_age_data['name'])
st.write('出勤希望: ', max_age_data['出勤希望'])
